        ...
        <center>
            <form action="{{route('board.store')}}" method="POST">
                ...
                <div class="form_group">
                    <div class="form_box">
                        <div class="name_box">
                            <p id="name"><b>작성자</b></p><input type="text" class="name_input" name="writer" placeholder="작성자명" />
                        </div>
                        <div class="title_box">
                            <p id="title"><b>제목</b></p><input type="text" class="title_input" name="title" placeholder="제목을 입력 해 주세요" />
                        </div>
