...
namespace AWSSDK.Examples
{
    public class S3Example : MonoBehaviour
    {
        ...
        // ap-northeast-2:7502e180-f5b2-47c4-9843-b49c592b890e
        // ap-northeast-2:7502e180-f5b2-47c4-9843-b49c592b890e
        public string S3Region = RegionEndpoint.APNortheast2.SystemName; // 리전 설정
        ...
        private IAmazonS3 _s3Client; // 리전정의
        ...
        private void GetObject()
        {
            ...
            Client.GetObjectAsync(S3BucketName, SampleFileName, (responseObj) =>
            {
                ...
                if(response.ResponseStream != null)
                {
                    using (var fs = System.IO.File.Create(Application.persistentDataPath + Path.DirectorySeparatorChar + SampleFileName))
                    {
