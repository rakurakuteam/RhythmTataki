...
public class MakeBlock : MonoBehaviour
{
    ...
    public void M()
    {
        if (Swipe.instance.check == true)
        {
            ...
            miss.transform.localPosition = new Vector3(0, 600, 0);
            if (Swipe.instance.check2 == true)
            {
                //height += 200;
                //transform.position = new Vector3(0, height, 0);
                miss.transform.position = new Vector3(0, transform.position.y + Swipe.instance.height3, 90);
    ...
    public void G()
    {
        if (Swipe.instance.check == true)
        {
            ...
            good.transform.localPosition = new Vector3(0, 600, 0);

            if (Swipe.instance.check2 == true)
            {
               
                good.transform.position = new Vector3(0, transform.position.y + Swipe.instance.height3, 90);
                //Swipe.instance.check2 = false;
            }
        }
    }
